...
const invalidAgentOtpError = () => bodyError('Invalid or expired verification code.', 400);
const invalidPasswordError = (validation) => bodyError(
...
const accountNotFoundError = () => bodyError('No agent account found with this phone number.', 404);
