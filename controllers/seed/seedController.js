 ...
 * SuperAdmin model exclusively. Use bootstrapInitialSuperAdmin.js instead.
 *
...
const seedAdmin = async (req, res) => {
    return res.status(410).json({
        status: false,
        message: "Deprecated: Admin users are no longer created in the User collection. Use the SuperAdmin model and bootstrapInitialSuperAdmin.js script instead.",
