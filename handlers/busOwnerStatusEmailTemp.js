function generateBusOwnerStatusEmail(name, statusText, invalidDocs = []) {
    const safeName = name || "Bus Owner";
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">Bus Owner KYC Update</div>
          <p>Dear ${safeName},</p>
...
module.exports = generateBusOwnerStatusEmail;
