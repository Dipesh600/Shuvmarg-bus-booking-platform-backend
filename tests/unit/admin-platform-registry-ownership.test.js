...
test("platform registry exports only its declared route handlers", () => {
  ...
  assert.deepEqual(Object.keys(registry).sort(), [
    ...
    "deactivateBoardingLocation", "deleteCorridor", "deleteHistoricalRevision", "deleteRegistryBoardingPoint",
    ...
    "repairVariantPair", "retireVariantPair", "reviewBoardingAssignment", "rollbackVariantRevision", "searchStops", "searchVariantDraftGuidancePlaces",
